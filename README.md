...
<img src="documentation/testing/pep8_validation.png" alt="Flake8 Python validation result" width="700">

Python code was checked with Flake8. The command returned no issues.
